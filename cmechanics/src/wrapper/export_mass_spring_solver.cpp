...
void export_mass_spring_solver () {
	class_<MSSolver2D>("CMSSolver2D",init<>())
		...
		.def("compute_forces",&MSSolver2D::compute_forces,"compute forces")
		.def("update_positions",&MSSolver2D::update_positions,"change position according to computed forces")
		.def("force_max",&MSSolver2D::force_max,"maximal force computed")
	...
	class_<MSSolver3D>("CMSSolver3D",init<>())
		...
		.def("compute_forces",&MSSolver3D::compute_forces,"compute forces")
		.def("update_positions",&MSSolver3D::update_positions,"change position according to computed forces")
		.def("force_max",&MSSolver3D::force_max,"maximal force computed")
		.def("deform",&MSSolver3D::deform,"compute deformation")
