...
#ifndef __CMECHANICS_SPRING_FEM_H__
#define __CMECHANICS_SPRING_FEM_H__
...
namespace mechanics {
	...
	class CMECHANICS_EXPORT TriangleMembrane3D : public Spring3D {
	public:
...
#endif //__CMECHANICS_SPRING_FEM_H__
