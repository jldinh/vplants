 ...
 *------------------------------------------------------------------------------
 *                                                                              
 *        openalea.cmechanics: spring package                                     
 *                                                                              
...
#ifndef __CMECHANICS_SPRING_H__
#define __CMECHANICS_SPRING_H__

#include "mechanics_utils.h"

namespace mechanics {
	class CMECHANICS_EXPORT Spring2D {
	public:
		Spring2D () {}
	...
	class CMECHANICS_EXPORT Spring3D {
	public:
		Spring3D () {}
	...
	class CMECHANICS_EXPORT LinearSpring2D : public Spring2D {
	private:
		int _pid1;
		int _pid2;
		double _stiffness;
	...
	class CMECHANICS_EXPORT LinearSpring3D : public Spring3D {
	private:
		int _pid1;
		int _pid2;
		double _stiffness;
