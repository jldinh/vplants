# -*- coding: utf-8 -*-
__revision__ = "$Id: setup.py 12346 2012-06-26 07:11:42Z pradal $"
...
# * name is the full name (e.g., .Tutorial) whereas pkg_name is only 'tutorial'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['tutorial = tutorial_wralea' ],
        },
    )
