...
First, we load the digitized Walnut :download:`noylum2.mtg <../../share/data/PlantFrame/noylum2.mtg>`
...
DressingData (:download:`walnut.drf <../../share/data/PlantFrame/walnut.drf>` )
...
First,  we load the MTG :download:`monopodial_plant.mtg <../../share/data/PlantFrame/monopodial_plant.mtg>`
...
.. code-block:: python
    ...
    >>> g.plot(roots=4, node=dict(fc=coloring, label=label), prog="dot")
