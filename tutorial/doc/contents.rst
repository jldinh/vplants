...
- A `PDF <../latex/tutorial.pdf>`_ version of |tutorial| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages::tutorial:tutorial>`__ wiki.
...
|tutorial| is released under a Cecill-C License.
