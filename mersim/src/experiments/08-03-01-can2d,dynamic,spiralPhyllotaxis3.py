...
__revision__="$Id: 08-03-01-can2d,dynamic,spiralPhyllotaxis3.py 7875 2010-02-08 18:24:36Z cokelaer $"
        ...
        for i in t.cells():
            ...
            if not self.i_local_evacuate( i ):
                ...
                for n in t.cell_neighbors(i):
                    x2[ self.cell2sys[ i ] ] += W((i,n))*J((n,i),t,x)/S(i) #- J((i,n),t,x)
...
class TissueSystem:
    ...
    def run( self , nbr):
        ...
        self.phys.c_primordium_fade_out_time=500
        self.phys.init_aux()
        self.phys.init_pin()
    ...
    def run1( self , nbr):
        ...
        self.phys.c_step_nbr=1
        self.phys.h=1.
        self.phys.c_prim_trs=7.7
        self.phys.c_primordium_fade_out_conc_max=5
        self.phys.c_primordium_fade_out_time=750
        self.phys.init_aux()
        self.phys.init_pin()
        self.phys.c_dynamic_aux=True
        self.step(nbr,prefix=self.c_tissue_dir)
    ...
    def run2( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-03-01-can2d,dynamic,spiralPhyllotaxis3-2/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
        ...
        self.phys.h=1.
        self.phys.c_prim_trs=7.7
        self.phys.c_primordium_fade_out_conc_max=7
        self.phys.c_primordium_fade_out_time=500
        self.phys.init_aux()
        self.phys.init_pin()
        self.phys.c_dynamic_aux=True
    ...
    def run3( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-03-01-can2d,dynamic,spiralPhyllotaxis3-3/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
    ...
    def run4( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-03-01-can2d,dynamic,spiralPhyllotaxis3-4/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
    ...
    def run5( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-03-01-can2d,dynamic,spiralPhyllotaxis3-5/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
    ...
    def run6( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-03-01-can2d,dynamic,spiralPhyllotaxis3-6/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
    ...
    def run7( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-03-01-can2d,dynamic,spiralPhyllotaxis3-7/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
    ...
    def run8( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-03-01-can2d,dynamic,spiralPhyllotaxis3-8/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
    ...
    def run9( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-03-01-can2d,dynamic,spiralPhyllotaxis3-9/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
        ...
        self.phys.c_step_nbr=1
        self.phys.h=1.
        self.phys.c_prim_trs=7.35
        self.phys.c_primordium_fade_out_conc_max=5
        self.phys.c_primordium_fade_out_time=200
        self.phys.init_aux()
        self.phys.init_pin()
        self.phys.c_dynamic_aux=True
        self.step(nbr,prefix=self.c_tissue_dir)
    ...
    def run10( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-03-01-can2d,dynamic,spiralPhyllotaxis3-10/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
    ...
    def run11( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-03-01-can2d,dynamic,spiralPhyllotaxis3-11/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
    ...
    def save_phyllotactic_data11( self, folder=""):
