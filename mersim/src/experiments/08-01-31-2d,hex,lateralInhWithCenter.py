...
__revision__="$Id: 08-01-31-2d,hex,lateralInhWithCenter.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def run( self, nbr=30, nbr2=10 ):
        ...
        for i in range(nbr):
            self.phys.run()
            self.write_tissue("/home/stymek/mtmp/hex,3sinksWithCenter-1/"+str(self.frame))
            self.frame+=1
