...
__revision__="$Id: 08-01-31-2d,hex,lateralInhCubicPhi-2.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def run( self, nbr=60, nbr2=10 ):
        ...
        for i in range(nbr):
            self.phys.run()
            self.update_visualisation(abs_intercellular_space=0.05, revers=True, material_f=auxin2material6, wall_color=pgl.Color4(255,255,255,0))
            self.write_tissue("/home/stymek/mtmp/hex,3sinksAllPrimsSameMomentCubicPhi-2/"+str(self.frame))
            self.frame+=1
