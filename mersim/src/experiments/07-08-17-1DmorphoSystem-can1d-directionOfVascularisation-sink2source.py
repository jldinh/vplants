...
__revision__="$Id: 07-08-17-1DmorphoSystem-can1d-directionOfVascularisation-sink2source.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys=Phys1Dcanalisation3( tissue_system=self )
