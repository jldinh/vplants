...
__revision__="$Id: 08-02-21-2d,hex,veinAndWound-testEq.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def run0( self, nbr=30, nbr2=10, folder="/home/stymek/mtmp/08-02-21-2d,hex,veinAndWound-testEq/" ):
        self.phys.c_break_step_nbr=nbr2
        for i in range(nbr):
            self.phys.run()
            self.write_tissue("/home/stymek/mtmp/08-02-21-2d,hex,veinAndWound-testEq/"+str(self.frame))
            self.update_visualisation(abs_intercellular_space=0.05, revers=True, material_f=auxin2material6, wall_color=pgl.Color4(255,255,255,0),
                                      prefix=folder+"vis/1/")
            self.frame+=1

            
    def run( self, nbr=30, nbr2=10, folder="/home/stymek/mtmp/08-02-21-2d,hex,veinAndWound-testEq/" ):
        self.phys.c_break_step_nbr=nbr2
...
#s.load_tissue( "/home/stymek/mtmp/08-02-19-2d,hex,veinAndWound/45/" )
#s.frame=46
#s.phys.c_sigma_a_prim=2.
#sinks=range(648,657)    
#for i in sinks:
