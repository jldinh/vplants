#!/usr/bin/env python
"""Reads the mariannes meristem-01 from a file.
...
__revision__="$Id: 08-05-20-readingMarianne1Meristem.py 8407 2010-03-08 07:53:28Z pradal $"
    ...
    def cell2flux_f(self):
        ...
        for i in self.tissue.cells():
            ...
            for n in self.tissue.cell_neighbors( i ):
               ...
               k+=1
            d[i]=min(zm, zp)/float(k)#/calculate_cell_surface( self.tissue, cell=i )
        return d
...
s.update_visualisation(max_wall_absolute_thickness=0.06,cell_marker_size=0.05,abs_intercellular_space=0.01,revers=False, material_f=flux2material, pump_color=pgl.Color4(255,0,0,0), wall_color=pgl.Color4(0,0,0,0),
                                      prefix="/home/stymek/mtmp/08-04-15-real,fluxMap/"+"vis/1/")
