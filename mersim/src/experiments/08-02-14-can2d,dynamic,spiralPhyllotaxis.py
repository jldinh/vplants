...
__revision__="$Id: 08-02-14-can2d,dynamic,spiralPhyllotaxis.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def __init__( self, tissue, const=None ):
        ...
        self.c_tissue_dir="/home/stymek/mtmp/08-02-14-can2d,dynamic,spiralPhyllotaxis/"
    ...
    def run( self , nbr):
        ...
        self.phys.h=1.
        self.phys.c_prim_trs=6.5
        self.phys.c_primordium_fade_out_conc_max=5
        self.phys.c_primordium_fade_out_time=300
        self.phys.init_aux()
        self.phys.init_pin()
    ...
    def step( self, nbr=1 ):
        for i in range( nbr ):
            ...
            self.update_visualisation( revers=True, material_f=auxin2material3, pump_color=pgl.Color4(255,0,0,0), wall_color=pgl.Color4(0,0,0,0))
            self.growth.apply()
