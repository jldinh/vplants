...
__revision__="$Id: 07-07-32-tissueWrite.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
def write( s ):
    wtp = WalledTissuePickleWriter( "/home/stymek/mdata/07-07-02-2dTissueWithAP,equilibrated", mode="w",
                           ...
                           description="07-07-02-2dTissueWithAP,equilibrated" )
    wtp.write_all()
