...
__revision__="$Id: 08-02-11-2d,real,maxInInitium-withCenter,prim1cellWide-KramerPumps.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class Phys(PhysAuxinTransportModel):
    ...
    def __init__(self, tissue_system = None):
        ...
        self.c_gamma_act = 0.2 #active flux coef.
        self.c_iaa_act_enabled=True
        self.c_gamma_diff = 0.01 # diffusion coef.
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def play1( self, folder="/home/stymek/mtmp/08-02-11-2d,real,maxInInitium-withCenter,prim1cellWide-KramerPumps/"):
        ...
        while True:
            ...
            self.update_visualisation(max_wall_absolute_thickness=0.05,cell_marker_size=0.05,abs_intercellular_space=0.01,revers=False,
                                      material_f=auxin2material6, pump_color=pgl.Color4(255,0,0,0), wall_color=pgl.Color4(0,0,0,0),
                                      prefix=folder+"/vis/1/")
            #self.frame+=1
            
    def run( self, nbr=80, nbr2=10 ):
        cc = 346
        p0 = 460
        p1 = 258
        p2 = 170
        ...
        self.write_tissue("/home/stymek/mtmp/08-02-11-2d,real,maxInInitium-withCenter,prim1cellWide-KramerPumps/"+str(self.frame))
        self.frame+=1
