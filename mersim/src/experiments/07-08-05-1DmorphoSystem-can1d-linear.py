...
__revision__="$Id: 07-08-05-1DmorphoSystem-can1d-linear.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#for i in range(0,15):
s.tissue.cell_property( 20, "CZ", 1)
#s.tissue.cell_property( 30, "CZ", 1)
s.phys.init_aux()
