...
__revision__="$Id: 08-01-24-2d,hex,lateralInh.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def run( self, nbr=30, nbr2=10 ):
        ...
        for j in range(3):
            ...
            for i in range(nbr):
                self.phys.run()
                self.write_tissue("/home/stymek/mtmp/hex,3sinks-1/"+str(self.frame))
                self.frame+=1
    ...
    def run2( self, nbr=80, nbr2=10 ):
        ...
        for j in range(3):
            ...
            for i in range(nbr):
                self.phys.run()
                self.write_tissue("/home/stymek/mtmp/hex,3sinks-2/"+str(self.frame))
                self.frame+=1
