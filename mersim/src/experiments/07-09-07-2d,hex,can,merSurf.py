...
__revision__="$Id: 07-09-07-2d,hex,can,merSurf.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
for i in s.tissue.nth_layer_from_cell(cc, 7):
    s.tissue.cell_property(i, "BC", 1)

s.mark_center_cells( cc )
...
s.phys=PhysAuxinTransportModel38( tissue_system=s )
s.phys.init_aux()
s.phys.init_pin()
ccn=s.tissue.cell_neighbors( cc )
#s.phys.pin( (cc,ccn[0]), 0.4 )
