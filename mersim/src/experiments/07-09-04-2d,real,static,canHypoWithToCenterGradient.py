...
__revision__="$Id: 07-09-04-2d,real,static,canHypoWithToCenterGradient.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def update_visualisation( self, cell=None ):
        ...
        visualisation_pgl_2D_linear_tissue_aux_pin( self.tissue, concentration_range=self.concentration_range, pin_range=(0.09,0.4), max_wall_absolute_thickness=0.035, cell_marker_size=0.03 )
...
w = WalledTissue( const=WalledTissuePinMapsExp3() )
...
for i in s.tissue.cells():
    t = i in BC
    s.tissue.cell_property( i, "BC", t )
    #if not s.tissue.cell_property( i, "BC"):
...
s.phys=PhysAuxinTransportModel36( tissue_system=s )
s.phys.init_aux()
s.phys.init_pin()
