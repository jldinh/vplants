...
__revision__="$Id: 08-04-07-loadRealWithZones2.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def play1( self, folder="/home/stymek/mtmp/realPierres1withCenter-1/"):
    ...
    def run( self, nbr=60, nbr2=10, folder="/home/stymek/mtmp/realPierres1withCenter-1/" ):
        cc = 346
        p0 = 460
        p1 = 258
        p2 = 170
...
s.load_tissue("/home/stymek/mtmp/realPierres1withCenter-1/61/")
for (i,j) in t.cell_edges():
    pin_level( s.tissue, (i,j), pin_level( t, (i,j))/5.)
    (i,j)=(j,i)
    pin_level( s.tissue, (i,j), pin_level( t, (i,j))/5.)

for i in s.tissue.cells():
    auxin_level(s.tissue, i, 0.)

s.update_visualisation(max_wall_absolute_thickness=0.06,cell_marker_size=0.1,abs_intercellular_space=0.01, revers=False, material_f=auxin2material5, pump_color=pgl.Color4(255,0,0,0), wall_color=pgl.Color4(0,0,0,0))
s.frame=1
