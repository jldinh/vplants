...
__revision__="$Id: 08-07-08-can2d,dynamic,spiralPhyllotaxis2-errorTest.py 7875 2010-02-08 18:24:36Z cokelaer $"
    ...
    def search_for_primodium( self ):
        ...
        for c in t.cells():
            if t.cell_property( cell=c, property="PZ"):
                if self.aux( cell = c )+self.c_trs_error*(random.random()-0.5)*self.c_prim_trs > self.c_prim_trs:
                    pc.append( c )
        return pc
...
class TissueSystem:
    ...
    def run2( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-07-08-can2d,dynamic,spiralPhyllotaxis2-errorTest/"
    ...
    def run3( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-07-08-can2d,dynamic,spiralPhyllotaxis2-errorTest-3/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
        ...
        self.phys.c_step_nbr=1
        self.phys.h=1.
        self.phys.c_trs_error=0.04
        self.phys.c_prim_trs=6.8+6.8*0.04
        self.phys.c_primordium_fade_out_conc_max=5
        self.phys.c_primordium_fade_out_time=400
        self.phys.init_aux()
        self.phys.init_pin()
    ...
    def run4( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-07-08-can2d,dynamic,spiralPhyllotaxis2-errorTest-4/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
        ...
        self.phys.c_step_nbr=1
        self.phys.h=1.
        self.phys.c_prim_trs=6.8+6.8*0.05
        self.phys.c_trs_error=0.05
        self.phys.c_primordium_fade_out_conc_max=5
        self.phys.c_primordium_fade_out_time=400
        self.phys.init_aux()
        self.phys.init_pin()
    ...
    def run5( self , nbr):
        self.c_tissue_dir="/home/stymek/mtmp/08-07-08-can2d,dynamic,spiralPhyllotaxis2-errorTest-5/"
        self.phys.c_stable_tolerance=0.01
        self.phys.c_atol=0.001
        self.phys.c_rtol=0.001
        self.phys.c_sigma_a=0.3
        ...
        self.phys.c_step_nbr=1
        self.phys.h=1.
        self.phys.c_prim_trs=6.8+6.8*0.6
        self.phys.c_trs_error=0.06
        self.phys.c_primordium_fade_out_conc_max=5
        self.phys.c_primordium_fade_out_time=400
        self.phys.init_aux()
        self.phys.init_pin()
