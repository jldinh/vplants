...
__revision__="$Id: 07-08-17-1DmorphoSystem-can1d-directionOfVascularisation-source2sink.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys=Phys1Dcanalisation2( tissue_system=self )
    ...
    def update_visualisation( self, cell=None ):
        ...
        visualisation_pgl_1D_linear_tissue_aux_pin(self.tissue, concentration_range=self.concentration_range, pin_range=(0,4), max_wall_absolute_thickness=1., cell_marker_size=1.)
...
s.tissue.cell_property( 0, "PrZ", 1)
s.phys.init_aux()
