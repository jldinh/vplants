...
__revision__="$Id: 07-07-13-PinDisplayTest.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys=PhysAuxinTransportModel29( tissue_system=self )
    ...
    def update_visualisation( self, cell=None ):
        ...
        #visualisation3( self.tissue, concentration_range=self.concentration_range, pin_range=[0.99,1.5] )
...
w = WalledTissue( const=WalledTissueVisuTest() )
#w.const.mdata= Mdata.two_cells
...
#pin_level( s.tissue, cell_edge=(0,1), value=1.3)
