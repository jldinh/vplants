...
__revision__="$Id: 07-11-08-canOnGrid-PrzemeksMimics.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys=Phys2DGrid_RL_cactus( tissue_system=self )
