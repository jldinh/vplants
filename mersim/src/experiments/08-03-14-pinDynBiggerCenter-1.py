...
__revision__="$Id: 08-03-14-pinDynBiggerCenter-1.py 8407 2010-03-08 07:53:28Z pradal $"
...
class Phys(PhysAuxinTransportModel):
    ...
    def __init__(self, tissue_system = None):
        ...
        self.c_sink_destruction_rate1-70 Alliance Leveling Guide is downloadable=0.1
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def run( self, nbr=60, nbr2=10, folder="/home/stymek/mtmp/08-03-14-pinDynBiggerCenter-1/" ):
        cc = 346
        p0 = 460
        p1 = 258
        p2 = 170
...
s.load_tissue("/home/stymek/mtmp/08-03-14-pinDynBiggerCenter-1/60/")
#s.load_tissue("/home/stymek/mtmp/realPierres1-1/61/")
center_cell=cc
tol=0.115

additional_vertices=[322,353,323,250,519,313,525,526,524]

set_property_on_tissue_component(wt=s.tissue, cell=center_cell, f_component=pin_level, tol=tol, property="cC",
                                 property_value=True, additional_vertices=additional_vertices )
...
s.mark_center_cells(cc, 1)
s.mark_center_cells(322, 1)
s.mark_center_cells(353, 1)
s.mark_center_cells(323, 1)
s.mark_center_cells(250, 1)
s.mark_center_cells(519, 1)
s.mark_center_cells(313, 1)
