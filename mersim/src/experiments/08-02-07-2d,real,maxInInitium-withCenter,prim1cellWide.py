...
__revision__="$Id: 08-02-07-2d,real,maxInInitium-withCenter,prim1cellWide.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def play1( self, folder="/home/stymek/mtmp/08-02-07-2d,real,maxInInitium-withCenter,prim1cellWide/"):
    ...
    def run( self, nbr=80, nbr2=10 ):
        ...
        self.write_tissue("/home/stymek/mtmp/08-02-07-2d,real,maxInInitium-withCenter,prim1cellWide/"+str(self.frame))
        self.frame+=1
