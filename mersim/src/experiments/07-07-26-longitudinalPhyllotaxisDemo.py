...
__revision__="$Id: 07-07-26-longitudinalPhyllotaxisDemo.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def update_visualisation( self ):
        ...
        visualisation_pgl_2D_linear_tissue_aux_pin( self.tissue, concentration_range=self.concentration_range, pin_range=(0,4), max_wall_absolute_thickness=0.09, cell_marker_size=0.03)
