...
__revision__="$Id: 07-07-24-1DmorphoSystem-basics.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys=PhysDiffWithSinkModel1( tissue_system=self )
...
wtpr = WalledTissuePickleReader( "/home/stymek/mdata/1DroundTissue100", mode="r")
wtpr.read_tissue()
...
#for i in range(0,15):
s.tissue.cell_property( 50, "CZ", 1)
s.phys.init_aux()
