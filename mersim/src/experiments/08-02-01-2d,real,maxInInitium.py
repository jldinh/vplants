...
__revision__="$Id: 08-02-01-2d,real,maxInInitium.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def run( self, nbr=60, nbr2=10, folder="/home/stymek/mtmp/realPierres1-1/" ):
        cc = 346
        p0 = 460
        p1 = 258
        p2 = 170
