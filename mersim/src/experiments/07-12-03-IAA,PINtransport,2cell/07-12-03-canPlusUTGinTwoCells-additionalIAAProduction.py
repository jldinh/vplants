...
__revision__="$Id: 07-12-03-canPlusUTGinTwoCells-additionalIAAProduction.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class ConfigODE(object):
    ...
    1/ cell0 pumps to cell1, cell0 has lower conc. of IAA
    2/ cell0 pumps to cell1, cell0 has higher conc. of IAA
    The cell0 produce IAA, cell1 removes it.
    Case 1 is possible only when transport is 0.
