...
__revision__="$Id: 07-12-03-3-canPlusUTGinTwoCells-additionalIAAProduction,transportSat.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class ConfigODE(object):
    ...
    The saturation of active transport was added. It leeds to the reversal of the situation:
    1/ cell0 pumps to cell1, cell0 has *higher* conc. of IAA
    2/ cell0 pumps to cell1, cell0 has lower conc. of IAA
