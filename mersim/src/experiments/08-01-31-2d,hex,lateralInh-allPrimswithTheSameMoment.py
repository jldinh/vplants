...
__revision__="$Id: 08-01-31-2d,hex,lateralInh-allPrimswithTheSameMoment.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def play1( self, folder="/home/stymek/mtmp/hex,3sinksAllPrimsSameMoment-1/"):
        ...
        while True:
            ...
            self.update_visualisation(abs_intercellular_space=0.05, revers=True, material_f=auxin2material6, wall_color=pgl.Color4(255,255,255,0), prefix=folder+"/vis/1/")
            #self.frame+=1
    ...
    def run( self, nbr=60, nbr2=10 ):
        ...
        for i in range(nbr):
            self.phys.run()
            self.write_tissue("/home/stymek/mtmp/hex,3sinksAllPrimsSameMoment-1/"+str(self.frame))
            self.frame+=1
