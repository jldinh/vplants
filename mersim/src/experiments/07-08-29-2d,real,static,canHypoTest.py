...
__revision__="$Id: 07-08-29-2d,real,static,canHypoTest.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys=PhysAuxinTransportModel35( tissue_system=self )
    ...
    def update_visualisation( self, cell=None ):
        ...
        visualisation_pgl_2D_linear_tissue_aux_pin( self.tissue, concentration_range=self.concentration_range, pin_range=self.pin_range, max_wall_absolute_thickness=0.04, cell_marker_size=0.03 )
