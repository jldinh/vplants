...
__revision__="$Id: 08-02-14-2d,long,mimicingLeaf.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def play( self, folder="/home/stymek/mtmp/08-02-14-2d,long,mimicingLeaf/"):
    ...
    def run( self, nbr=60, nbr2=10, folder="/home/stymek/mtmp/08-02-14-2d,long,mimicingLeaf/" ):
    ...
    def play2( self, folder="/home/stymek/mtmp/08-02-14-2d,long,mimicingLeaf-2/"):
        green_range._position_list=[0.,0.7,1.]
        self.c_dynamic_aux=False
        self.c_disp_aux_max=5
        pgl.Viewer.frameGL.setBgColor(pgl.Color3(255,255,255))
    ...
    def run2( self, nbr=60, nbr2=10, folder="/home/stymek/mtmp/08-02-14-2d,long,mimicingLeaf-2/" ):
        self.write_tissue(folder+str(self.frame))
        self.frame+=1
        self.phys.c_break_step_nbr=nbr2
        self.phys.c_sigma_a=0.2
    ...
    def play3( self, folder="/home/stymek/mtmp/08-02-14-2d,long,mimicingLeaf-3/"):
        green_range._position_list=[0.,0.7,1.]
        self.c_dynamic_aux=False
        self.c_disp_aux_max=5
        pgl.Viewer.frameGL.setBgColor(pgl.Color3(255,255,255))
    ...
    def run3( self, nbr=60, nbr2=10, folder="/home/stymek/mtmp/08-02-14-2d,long,mimicingLeaf-3/" ):
        self.write_tissue(folder+str(self.frame))
        self.frame+=1
        self.phys.c_break_step_nbr=nbr2
        self.phys.c_sigma_a=0.2
        ...
        #self.tissue.cell_property(187,"Source",1)
        self.phys.c_sigma_a_prim=0.8
        for j in [165,170,182,187]:
            self.tissue.cell_property(j,"Source",1)
            for i in range(30):        
                self.phys.run()
                self.write_tissue(folder+str(self.frame))
                self.frame+=1
