...
__revision__="$Id: 08-01-31-2d,hex,lateralInhCubicPhi.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def play1( self, folder="/home/stymek/mtmp/hex,3sinksAllPrimsSameMomentCubicPhi-1/"):
    ...
    def play2( self, folder="/home/stymek/mtmp/hex,3sinksAllPrimsSameMomentCubicPhi-1/"):
        #green_range._position_list=[0.,0.94,1.]
        self.c_dynamic_aux=True
        self.c_disp_aux_max=5
        while True:
    ...
    def run( self, nbr=60, nbr2=10 ):
        ...
        for i in range(nbr):
            self.phys.run()
            self.update_visualisation(abs_intercellular_space=0.05, revers=True, material_f=auxin2material6, wall_color=pgl.Color4(255,255,255,0))
            self.write_tissue("/home/stymek/mtmp/hex,3sinksAllPrimsSameMomentCubicPhi-1/"+str(self.frame))
            self.frame+=1
