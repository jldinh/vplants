...
__revision__="$Id: 07-12-16-can1d,AUXandPIN.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem(object):
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys= Phys1DcanalisationAUX( tissue_system=self )
        self.frame=0
        self.tissue.time=0
...
s.phys.c_gamma = 0.01
s.phys.c_gamma_diff = 0.00
s.phys.c_ksi = 2
s.phys.c_fi_deg = 0.

s.phys.c_initial_aux_value = 0 #s.phys.c_sigma_a_prim/s.phys.c_theta_a
