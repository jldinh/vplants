...
__revision__="$Id: 08-02-06-2d,hex,lateralInhibition2primInTheSameTime.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def play1( self, folder="/home/stymek/mtmp/08-02-06-2d,hex,lateralInhibition2primInTheSameTime/"):
        ...
        while True:
            ...
            self.update_visualisation(abs_intercellular_space=0.05, revers=True, material_f=auxin2material6, wall_color=pgl.Color4(255,255,255,0),
                                      prefix="/home/stymek/mtmp/08-02-06-2d,hex,lateralInhibition2primInTheSameTime/vis/1/")
            #self.frame+=1
    ...
    def run( self, nbr=60, nbr2=10 ):
        ...
        for i in range(nbr):
            self.phys.run()
            self.write_tissue("/home/stymek/mtmp/08-02-06-2d,hex,lateralInhibition2primInTheSameTime/"+str(self.frame))
            self.frame+=1
