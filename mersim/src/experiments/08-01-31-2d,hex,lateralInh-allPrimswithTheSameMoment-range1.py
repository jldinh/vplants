...
__revision__="$Id: 08-01-31-2d,hex,lateralInh-allPrimswithTheSameMoment-range1.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def play1( self, folder="/home/stymek/mtmp/hex,3sinksAllPrimsSameMoment-biggerRange1/"):
    ...
    def run( self, nbr=60, nbr2=10 ):
        ...
        for i in range(nbr):
            self.phys.run()
            self.write_tissue("/home/stymek/mtmp/hex,3sinksAllPrimsSameMoment-biggerRange1/"+str(self.frame))
            self.frame+=1
