...
__revision__="$Id: 07-08-14-longitudinalPhyllotaxisDemo.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys=PhysAuxinLongitudianTransportModel2( tissue_system=self )
    ...
    def update_visualisation( self ):
        ...
        visualisation_pgl_2D_linear_tissue_aux_pin( self.tissue, concentration_range=self.concentration_range, pin_range=self.pin_range, max_wall_absolute_thickness=0.09, cell_marker_size=0.03)
...
for i in range(160,192):
    s.tissue.cell_property( cell=i, property="PrC", value=1)
