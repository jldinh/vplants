...
__revision__="$Id: 08-02-08-2d,long,vein,upCell.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def play( self, folder="/home/stymek/mtmp/08-02-08-2d,long,vein,upCell/"):
    ...
    def play2( self, folder="/home/stymek/mtmp/08-02-08-2d,long,vein,upCell-2/"):
        green_range._position_list=[0.,0.7,1.]
        self.c_dynamic_aux=False
        self.c_disp_aux_max=5
        pgl.Viewer.frameGL.setBgColor(pgl.Color3(255,255,255))
    ...
    def run2( self, nbr=60, nbr2=10 ):
        self.write_tissue("/home/stymek/mtmp/08-02-08-2d,long,vein,upCell-2/"+str(self.frame))
        self.frame+=1
        ...
        for i in range(30):
            ...
            self.write_tissue("/home/stymek/mtmp/08-02-08-2d,long,vein,upCell-2/"+str(self.frame))
            self.frame+=1
        self.tissue.cell_property(179,"Source",1)
        for i in range(20):
            self.phys.run()
            self.write_tissue("/home/stymek/mtmp/08-02-08-2d,long,vein,upCell-2/"+str(self.frame))
            self.frame+=1
        ...
        for i in range(20):
            self.phys.run()
            self.write_tissue("/home/stymek/mtmp/08-02-08-2d,long,vein,upCell-2d/"+str(self.frame))
            self.frame+=1
...
#pgl.Viewer.camera.set( (3.5,3.5,6.8), -90, -90 )
