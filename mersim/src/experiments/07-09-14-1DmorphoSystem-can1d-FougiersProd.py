...
__revision__="$Id: 07-09-14-1DmorphoSystem-can1d-FougiersProd.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem(object):
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys=Phys1Dcanalisation9( tissue_system=self )
        self.frame=0
        self.tissue.time=0
...
p = {"c_sigma_p and c_theta_p": [(0.05,0.5)], 
        "c_kappa": [0.001],
        "c_sigma_a_prim and c_theta_a": [(10,0.)], #, (0.1,0.00001), (0.1,0.0001)
        "c_sigma_a": [20], 
        "c_gamma": [1.],
        "c_pin_max": [0.4 ],
        "sinks": [(0,0)]} #(15,35), (10,40),(5,45),
