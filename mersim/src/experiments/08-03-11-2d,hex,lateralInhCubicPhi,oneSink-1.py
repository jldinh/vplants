...
__revision__="$Id: 08-03-11-2d,hex,lateralInhCubicPhi,oneSink-1.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
#        self.phys=PhysAuxinTransportModel36( tissue_system=self )
    ...
    def play1( self, folder="/home/stymek/mtmp/08-03-11-2d,hex,lateralInhCubicPhi,oneSink-1/"):
    ...
    def run( self, nbr=80, nbr2=400 ):
        ...
        self.phys.c_PIN_capping_enabled=True
        self.phys.c_max_PIN=1.
        ...
        for i in range(nbr):
            self.phys.run()
            self.update_visualisation(abs_intercellular_space=0.05, revers=True, material_f=auxin2material6, wall_color=pgl.Color4(255,255,255,0),
                                      prefix="/home/stymek/mtmp/08-03-11-2d,hex,lateralInhCubicPhi,oneSink-1/"+"vis/1/")
            self.write_tissue("/home/stymek/mtmp/08-03-11-2d,hex,lateralInhCubicPhi,oneSink-1/"+str(self.frame))
            self.frame+=1
