...
__revision__="$Id: 07-08-14-pinMapsComparision.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def update_visualisation( self, cell=None ):
        ...
        visualisation_pgl_2D_linear_tissue_aux_pin( self.tissue, concentration_range=self.concentration_range, pin_range=(0.95,1.4), max_wall_absolute_thickness=0.04, cell_marker_size=0.03 )
...
for i in s.tissue.cells():
    s.tissue.cell_property( cell=i, property="auxin_level", value=1. )
#for i in s.tissue.
ss=pd.AISphere()
ss.visible=False
