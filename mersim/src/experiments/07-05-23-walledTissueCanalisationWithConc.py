...
__revision__="$Id: 07-05-23-walledTissueCanalisationWithConc.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys=PhysAuxinTransportModel23( tissue_system=self )
...
for i in s.tissue.cells():
    s.tissue.cell_property( cell=i, property="auxin_level", value=1*calculate_cell_surface( s.tissue, cell=i ) )
ss=pd.AISphere()
ss.visible=False
