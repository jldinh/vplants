...
__revision__="$Id: 07-07-09-pinMapsComparision-upTheHill.py 7875 2010-02-08 18:24:36Z cokelaer $"
...
class TissueSystem:
    ...
    def __init__( self, tissue, const=None ):
        self.tissue = tissue
        self.const=const
        self.phys=PhysAuxinTransportModel30( tissue_system=self )
    ...
    def update_visualisation( self, cell=None ):
        ...
        visualisationTODO( self.tissue, concentration_range=self.concentration_range, pin_range=self.pin_range )
