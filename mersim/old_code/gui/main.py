...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        QtCore.QObject.connect(self.actionQuit,QtCore.SIGNAL("triggered()"),MainWindow._layout.)
        QtCore.QObject.connect(self.lineEdit,QtCore.SIGNAL("textChanged(QString)"),MainWindow._layout.)
