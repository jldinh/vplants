...
# * name is the full name (e.g., VPlants.phyllotaxis_simulator) whereas pkg_name is only 'phyllotaxis_simulator'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['phyllotaxis_simulator = vplants.phyllotaxis_simulator_wralea'],
        #'console_scripts': [
