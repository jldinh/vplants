...
__revision__=" $Id: shell.py 7881 2010-02-08 18:33:35Z cokelaer $"
...
class MultipleRedirection:
	def __init__(self, shell, stream) :
		self.shell=shell
		self.stream=stream
...
class PyCutExt(QTextEdit):
    ...
    def __init__(self, local_variables, message="", log='', parent=None):
        """Constructor.
        ...
        self.interpreter.locals=local_variables
        ...
        sys.stderr   = MultipleRedirection(self,sys.stderr)
        sys.stdin    = self
        ...
        self.setLineWrapMode(QTextEdit.WidgetWidth)#NoWrap)
