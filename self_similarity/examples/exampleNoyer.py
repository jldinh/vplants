...
from VPlants.self_similarity.clustering import *
...
valeursmatrices=['long-diam.9.1_indel55','noDiam','paramEquiprob','long.5.5_indel','long-diam-1.5.5_indel55','long-diam.5.5_indel55','long-diam.25.75_indel55','long-diam.8.2_indel55','long-diam.05.95_indel55','orientationOnly','noLong']#'walnut','long-diam.95.05_indel55'
for valmatrice in valeursmatrices:
    ...
    max_class = 901#nb_nodes(tree_colored)
    #max_class = 9
    min_class = 900#3701
    nb_geo=1
    ...
    for i in range(min_class, max_class,800):
        # cluster
