...
# * name is the full name (e.g., tissue_data) whereas pkg_name is only 'tissue_data'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['tissue_data = .tissue_data_wralea' if has_project else 'tissue_data = tissue_data_wralea' ],
        #'console_scripts': [
