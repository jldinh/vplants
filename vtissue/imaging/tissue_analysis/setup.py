# -*- coding: utf-8 -*-
__revision__ = "$Id: setup.py 11271 2011-10-06 11:49:42Z jlegra02 $"
...
# * version is 0.9.1.0 and release 0.9.1
# * project must be in [openalea, vplants, alinea]
# * name is the full name (e.g., VPlants.tissue_analysis) whereas pkg_name is only 'tissue_analysis'
...
setup(
    ...
    entry_points = { 
        'wralea' : ['vplants.tissue_analysis = vplants.tissue_analysis_wralea',
        'vplants.tissue_analysis.workflow = vplants.workflow_wralea'],
        #'console_scripts': [
