...
#else
static int _VT_Seuil();
static int _VT_GreySeuil();
#endif
...
#else
int VT_Threshold( im1, im2, thres )
vt_image *im1; /* image to be thresholded */
vt_image *im2; /* image result */
float thres; /* threshold */
#endif
{
...
#else
int VT_Threshold2( im1, im2, thres1, thres2 )
vt_image *im1; /* image to be thresholded */
vt_image *im2; /* image result */
float thres1; /* first threshold */
float thres2; /* second threshold */
...
static int _VT_Seuil( vt_image *im1, 
		     ...
		     int flag )
#else
static int _VT_Seuil( im1, im2, fs1, fs2, flag )
vt_image *im1;
vt_image *im2;
float fs1;
float fs2;
...
int VT_GreyThreshold( vt_image *im1 /* image to be thresholded */,
		 ...
		 float thres /* threshold */ )
#else
int VT_GreyThreshold( im1, im2, thres )
vt_image *im1; /* image to be thresholded */
vt_image *im2; /* image result */
float thres; /* threshold */
#endif
...
int VT_GreyThreshold2( vt_image *im1 /* image to be thresholded */,
		  ...
		  float thres2 /* second threshold */ )
#else
int VT_GreyThreshold2( im1, im2, thres1, thres2 )
vt_image *im1; /* image to be thresholded */
vt_image *im2; /* image result */
float thres1; /* first threshold */
float thres2; /* second threshold */
...
static int _VT_GreySeuil( vt_image *im1, 
		     ...
		     int flag )
#else
static int _VT_GreySeuil( im1, im2, fs1, fs2, flag )
vt_image *im1;
vt_image *im2;
float fs1;
float fs2;
