...
#else
extern int  VT_ConnectedComponents();
extern int  VT_Hysteresis();
extern int  VT_ConnectedComponentWithOneSeed();
extern int  VT_ConnectedComponentsWithSeeds();
extern int  VT_CheckConnectivity();
extern void VT_Connexe();
#endif
