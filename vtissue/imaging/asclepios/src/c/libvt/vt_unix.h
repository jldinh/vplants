...
extern void  *VT_Malloc( unsigned int size );
...
extern double VT_Cos( double x );
extern double VT_Exp( double x );
extern double VT_Sin( double x );
extern double VT_Sqrt( double x );
