...
class VTissueAnalysis(object):
    """
    This object can extract a modeling template for the tissue, ie get some information about the number of cells,
    ...
    def nlabels(self):
        ...
        >>> from openalea.vtissue.analysis import VTissueAnalysis
