...
void set_isotropic_material (TriangleMembrane3D& tr, double E, double nu) {
	tr.set_material(isotropic_material2D(E,nu) );
}
...
void export_spring_fem () {
	class_<TriangleMembrane3D, bases<Spring3D> >("CTriangleMembrane3D",init<int,int,int,double,double,double,double>())
		.def("surface",&TriangleMembrane3D::surface,"surface of the triangle in reference state")
		.def("set_isotropic_material",&set_isotropic_material,"set_isotropic_material")
