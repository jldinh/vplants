...
- A `PDF <../latex/quasimc.pdf>`_ version of |quasimc| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:vplants:quasimc:quasimc>`__ wiki.
