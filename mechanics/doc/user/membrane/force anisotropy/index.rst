.. _meca_membrane_force_anisotropy:

##############################
Force anisotropy on membranes
##############################
...
.. seealso:: The result shown here might be compared with the one obtained in :ref:`meca_membrane_material_anisotropy`
...
A force is applied horizontally that pull apart both vertical edges with an intensity of 1e6 (N).
...
We will consider that an equilibrium is reached when the resulting force computed on each point is less than 1e-9 (N).
