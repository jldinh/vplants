...
pthread_includes = lapack_includes = cgal_includes = boost_includes = qhull_includes = readline_includes = termcap_includes = flex_include = mpfr_includes = gmp_includes = ann_includes=prefix+'/include'
